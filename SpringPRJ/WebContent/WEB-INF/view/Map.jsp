...
@import
	url("https://fonts.googleapis.com/css?family=Montserrat:200,400");
...
<body>
	...
	<div class="breadcomb-area">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="breadcomb-list" style="background-color: #00c292;">

						<div style="text-align: center;">
							<div class="overflow">
								<h2 class="pre-text" style="color: white;">Hello!</h2>
								<div id="text-animate">
									<h2>DB</h2>
									<h2>JH</h2>
									<h2>SB</h2>
					...
					<div class="tooltips-inner">
						<div id="map" style="width: 100%; height: 350px;">
							...
							<script>
								...
								mapOption = {
									center : new kakao.maps.LatLng(37.560770,126.961665),// 지도의 중심좌표
									level : 8
								// 지도의 확대 레벨
								};
