...
$( document ).ready(function() {
    ...
    async function init() {
        ...
        webcam = new tmPose.Webcam(550, size, flip); // width, height, flip
        ...
        canvas.width = 550; canvas.height = size;
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
					<div id="changecontentsclass=" class="view-mail-list sm-res-mg-t-30" style="text-align: center; margin: 0auto;">
						   <div>step 3</div>
